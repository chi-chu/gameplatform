...
class game {
    ...
    public function  __construct($player1, $player2, $gobang){
     ...
     */
    public function roll_number($player, $num){
     ...
     */
    public function chess($player, $position){
     ...
     */
    public function win($player, $position){
        $this->state = 3;
     ...
     */
    public function check_pos_valid($positon){
     ...
     * @param int $role 
     */
    public function add_position($position, $role){
     ...
     * @param string $msg
     */
    public function chat($speaker, $msg){
     ...
     *
     */
    public function init_chessboard(){
        for($i = 0; $i < 15; $i++){
            for($j = 0; $j < 15; $j++){
     ...
     *
     */
    public function send_both($type, $value = ""){
        foreach($this->players as $player){
     ...
     * @param int $role
     */
    public function check_if_win($positon, $role){
        $pos = explode("#", $positon);
        $x = $pos[0];
        $y = $pos[1];
        $hor = $ver = $slo = $len = 1;
